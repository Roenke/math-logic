\section{Интерпретация пропозициональной логики}
...
\item Докажите, что любая алгебра Гейтинга дистрибутивна. Hint: Нужно отдельно доказать, что
    ...
    Первое свойство верно в любой решетке, при доказательстве второго используется, что решетка ялвяется алгеброй 
    Гейтинга.
    ...
    Прежде всего:
    \begin{align*}
    	\psi \land \varphi &\leq (\varphi \land \psi) \lor (\varphi \land \chi) \Leftrightarrow \psi \leq 
    	(\varphi \to (\varphi \land \psi) \lor (\varphi \land \chi)) \\
    	\chi \land \varphi &\leq (\varphi \land \psi) \lor (\varphi \land \chi) \Leftrightarrow \chi \leq 
    	(\varphi \to (\varphi \land \psi) \lor (\varphi \land \chi))
    \end{align*}
